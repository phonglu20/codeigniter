    ...
    <div class="container">
        <div class="row" style="margin-left: 492px;">
            <div class="form-login" style="margin-top: 20px;">
                <form action="<?php echo base_url('thanh_vien/login'); ?>" name="login" method="post" enctype="multipart/form-data">
                    ...
                    <!-- <a href="<?php echo base_url('thanh_vien/quen_pass'); ?>">Quên Mật Khẩu</a> -->
                </form>
            </div>
