            ...
            <div class="kt-tabs style4 kt-tab-fadeeffect">
                ...
                <div class="tab-container" style="width: 1160px; z-index: 0;">
                    <div id="tab-1" class="tab-panel active">
                        <div href="#" style="font-size: 22px; margin-top: 8px;margin-bottom: 8px;">Kết quả tìm kiếm theo giá từ <?php echo number_format($from);?> VNĐ đến <?php echo number_format($to);?> VNĐ</div>
                        <!--<div class="num f12">Tổng số sản phẩm tìm được: <b><?php echo $total_rows; ?></b></div>-->
                        <ul style="float: left;">
