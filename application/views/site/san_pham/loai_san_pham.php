    ...
    <div class="col-sm-12 col-md-8 col-lg-9" style="width: 100%;">
        ...
        <div class="kt-tabs style4 kt-tab-fadeeffect">
            ...
            <div class="tab-container" style="width: 1160px; z-index: 0;">
                ...
                <!--
                    <form method="get" action="" style="margin: 10px 10px">
                        <div>
                            <input style="color: black;" type="text" value="<?php echo $this->input->get('cauhinh'); ?>" name="cauhinh" placeholder="Lọc cấu hình..." >
