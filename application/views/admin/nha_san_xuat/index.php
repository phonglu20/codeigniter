    ...
    <div class="wrapper">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
                        ...
                        <table width="80%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td style="width:150px">
                                    ...
                                    <input type="reset" onclick="window.location.href = '<?php echo admin_url('nha_san_xuat'); ?>'; " value="Reset" class="basic">
                                </td>
            ...
            <tr>
                ...
                <td style="width: 100px;">Mã nhà sản xuất</td>
                <td style="width: 100px;">Tên nhà sản xuất</td>
            ...
            <tr>
                <td colspan="8">
                    <div class="list_action itemActions">
                        <a href="#submit" id="submit" class="button blueB" url="<?php echo admin_url('nha_san_xuat/delete_all'); ?>">
            ...
            <?php foreach ($list as $row): ?>
                <tr class="row_<?php echo $row->ma; ?>">
                    ...
                    <td class="option">
                        <a href="<?php echo admin_url('nha_san_xuat/edit/'.$row->ma); ?>" title="Chỉnh sửa" class="tipS ">
                            <img src="<?php echo public_url(); ?>admin/images/icons/color/edit.png" />
                        </a>

                        <a href="<?php echo admin_url('nha_san_xuat/delete/'.$row->ma); ?>" title="Xóa" class="tipS verify_action" >
