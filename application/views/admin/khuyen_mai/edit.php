                ...
                <div class="tab_container">
                    <div class="tab_content pd0" id="tab1">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input type="text" _autocheck="true" id="param_name" value="<?php echo $list->tieu_de ;?>" name="name">
                                </span>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <img src="<?php echo base_url('upload/khuyen_mai/'.$list->hinh);?>" style="width: 120px; height: 90px">
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    ...
                                    {
                                    ;?>
                                        Đang sử dụng <input type="radio" name="trang_thai" value="1" ><br>
